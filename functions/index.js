...
// const receiverMail = process.env.SENDGRID_ORDER_RECEIVER_MAIL;
...
exports.sendRecip = functions.https.onRequest( async ( req, res) => {
  cors(req, res, () => {
    // creating sendgrid object request
    const apikey = req.body.dataSgmail.apikey; 
    sgMail.setApiKey(apikey);
    const senderMail = req.body.dataSgmail.senderMail;
    const receiverMail = req.body.dataSgmail.receiverMail;
    
    console.log(apikey, senderMail)
    const msg = {
      to: req.body.email,
      from: senderMail,
...
exports.sendMerchant = functions.https.onRequest( async ( req, res) => {
  cors(req, res, () => {
    // creating sendgrid object request
    const apikey = req.body.dataSgmail.apikey; 
    sgMail.setApiKey(apikey);
