  ...
  <div class="mt-8 max-w-sm sm:(max-w-lg mb-24) lg:(px-7 mt-0 max-w-full)">
    <div class="w-full px-3 mx-auto">
      ...
      <div v-if="!product.wishlistItems">
        <div class="w-full px-3 mx-auto">
          <h3 class="text-xl text-yellow-400 mb-2 font-bold lg:text-2xl">
      ...
      <div v-else class="overflow-auto">
        <div>
          <table
            class="w-full border-collapse border-collapse mb-4 text-dark-300"
          >
            ...
            <tbody>
              <template v-for="parentItem in product.wishlistItems">
                ...
                >
                  <td
                    class="min-w-[200px] px-[10px] py-[30px] lg:(align-middle)"
                  >
                    <product-shopping-cart :product="productItem" />
                  </td>
                  <td
                    class="min-w-[200px] px-[10px] py-[30px] align-middle text-center lg:w-40"
                  >
