    ...
    <div class="info-quick-view__shopping">
      <figure class="info-quick-view__figure">
        ...
        <div class="info-quick-view__actions">
          <button class="info-quick-view__actions-btn" @click.prevent="handleDescreaseQuantity">
            <div class="i-ph-minus-light text-xs text-gray-500" />
          </button>
          <input class="info-quick-view__actions-input" v-model="quantity" type="text" disabled />
          <button class="info-quick-view__actions-btn" @click.prevent="handleIncreaseQuantity">
      ...
      <button class="info-quick-view__btn-alt" @click.prevent="handleBuyNow(true)">
        Comprar
      </button>
    </div>
  </div>
